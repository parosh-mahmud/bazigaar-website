  ...
  return (
    <HomeLayout>
      <main>
        {/* banner */}
        <div
          className={`mt-14 lg:mt-0 !h-[600px] xl:!h-[700px] 2xl:!h-[785px] flex justify-center md:justify-end items-center content-end ${styles.heroBanner}`}>
          <div className="container">
            ...
            <h1 className="font-semiBold text-2xl lg:text-3xl xl:text-6xl text-center md:text-right text-white py-4">
              Win Big Lottery Jackpot!
            </h1>
            <h1 className="font-semiBold text-2xl lg:text-3xl xl:text-6xl text-center md:text-right text-white pb-8">
              Earn more playing games
            </h1>

            <button className="font-medium text-xl lg:text-2xl text-primary py-4 px-6 border border-primary rounded-lg w-full md:w-auto float-none md:float-right">
              Participate Now
            </button>
          </div>
        </div>
